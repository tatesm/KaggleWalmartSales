...
- Aggregation of markdown variables into total markdown amount, binary markdown indicator, and log transformed markdown total
...
- Tuned penalty and mixture parameters
...
- Incorporated external regressors including CPI, unemployment, markdown features, and holiday indicators
- Visualized fitted values and out of sample forecasts

## Evaluation Metric
Model performance was evaluated using Weighted Mean Absolute Error, WMAE.

- Weight equals 5 for holiday weeks
- Weight equals 1 for non holiday weeks

This metric reflects the higher business cost of poor holiday forecasts.

## Kaggle Submission Results
A valid submission was generated and evaluated on Kaggle public and private leaderboards.

- Public leaderboard WMAE approximately 3467  
- Private leaderboard WMAE approximately 3297  

The private score being lower than the public score suggests reasonable generalization and limited overfitting to the public leaderboard subset.
...
## Notes
This project prioritizes interpretability, generalization, and sound evaluation practices over leaderboard driven optimization. Emphasis was placed on understanding the drivers of retail demand and the impact of holidays and promotions on forecasting accuracy.
